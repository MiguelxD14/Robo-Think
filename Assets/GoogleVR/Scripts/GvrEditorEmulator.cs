...
public class GvrEditorEmulator : MonoBehaviour
{
    ...
    private bool CanChangeYawPitch()
    {
        ...
        return Input.GetKey(KeyCode.LeftAlt) || Input.GetKey(KeyCode.RightAlt) || Input.GetButtonDown("LT");
    }
    ...
    private bool CanChangeRoll()
    {
        ...
        return Input.GetKey(KeyCode.LeftControl) || Input.GetKey(KeyCode.RightControl) || Input.GetButtonDown("RT");
    }
